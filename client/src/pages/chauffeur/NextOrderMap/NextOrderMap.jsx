...
export default function NextOrderMapPage() {
  ...
  // ✅ CORRIGÉ: Suppression de 'PARTIELLE' des actions possibles
  const [statusAction, setStatusAction] = useState('') // 'LIVRE', 'ECHEC', 'ANNULE'
  ...
  // Récupérer l'utilisateur connecté (reste identique)
  useEffect(() => {
  ...
  // Récupérer les données de livraison (reste identique)
  useEffect(() => {
  ...
  // ✅ CORRIGÉ: Transformer les données sans PARTIELLE
  const transformLivraisonToOrder = (item) => {  
    ...
    // ✅ CORRIGÉ: Suppression de 'PARTIELLE' des états de livraison
  ...
  // ✅ CORRIGÉ: Mapping des statuts sans PARTIELLE
  ...
  if (activeOrders.length === 0 && orders.length > 0) {
    ...
    console.log('Statuts des commandes:', orders.map(o => ({ id: o.id, status: o.status, etat: o.etat })))  
  }  
  ...
  // ✅ CORRIGÉ: Suppression de l'état 'partial'
  ...
  // ✅ CORRIGÉ: Gérer les changements de statut sans PARTIELLE
  const handleStatusChange = async (order, newStatus, note = '') => {  
    ...
    setLoading(true)  
    try {  
      // ✅ CORRIGÉ: Suppression de 'PARTIELLE' du mapping
      const statusMapping = {  
        'LIVRE': 'LIVRE',  
        'ECHEC': 'ANNULE',  
        'ANNULE': 'ANNULE'  
      ...
      // ✅ CORRIGÉ: Suppression de 'PARTIELLE' du texte de statut
      const statusText = {  
        'LIVRE': 'livrée',  
        'ECHEC': 'annulée (échec)',  
        'ANNULE': 'annulée'  
                ...
                <div className="nom-card-content">    
                  <div className="nom-priority-content">    
                    ...
                    <div className="nom-priority-actions">    
                      ...
                      {/* ✅ CORRIGÉ: Suppression du bouton "Livraison Partielle" */}  
                      <button     
